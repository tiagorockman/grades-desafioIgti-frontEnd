# COMANDOS HEROKU
Instalar Heroku CLI --windows fazer download na página

run -> heroku login //realizar login
...
run -> git add * | git commit -m "msg" | git push heroku master // realiza commit no heroku
